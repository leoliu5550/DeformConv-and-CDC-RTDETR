...
def resize(image, target, max_size=None):
    with open("model_config.yaml") as file:
        cfg = yaml.safe_load(file)
    size=[cfg['train']['img_size'],cfg['train']['img_size']]
    ...
    if "boxes" in target:
        ...
        # print("#"*80)
        # print("ratio_wh")
        # print([ratio_width, ratio_height, ratio_width, ratio_height])
        # print(rescaled_image.size())
        scaled_boxes = boxes * torch.as_tensor([ratio_width, ratio_height, ratio_width, ratio_height])
        # print("scaled_boxes1 :")
        # print(scaled_boxes)
        scaled_boxes = scaled_boxes / rescaled_image.size()[1]
        # print("scaled_boxes2 :")
        # print(scaled_boxes)
